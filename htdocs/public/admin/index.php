...
<div class="grid stats">
  <div class="card stat"><span class="muted">Richieste totali</span><strong><?= $stats['contacts'] ?></strong></div>
  <div class="card stat"><span class="muted">Nuove richieste</span><strong><?= $stats['new_contacts'] ?></strong></div>
...
<div class="grid" style="grid-template-columns: repeat(3, minmax(0, 1fr));">
  <section class="card">
    <div class="actions" style="justify-content: space-between; margin-bottom: 14px;">
      <h2 style="margin:0;">Ultime richieste</h2>
